<?php
// https://github.com/laravel/framework/blob/35a8805603b63e18949cab5bb1c260261ddc1435/src/Illuminate/Support/helpers.php
...
if(!function_exists('random_string')){
    ...
    */
    function random_string($size=10){
        ...
        $res = '';
        do{
            $res .= str_shuffle($alpha);
        }while(strlen($res) < $size);
        return substr($res,0,$size);
    }
}
